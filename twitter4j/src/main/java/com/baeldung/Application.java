...
//		Twitter twitter = tf.getSingleton();
    ...
    public static String createTweet(String tweet) throws TwitterException {
        ...
        Status status = twitter.updateStatus("Day3: ->Solved a problem on linkedlist -- Given a singly linked list of integers l and a non-negative integer n, move the last n list nodes to the beginning of the linked list. \n #100DaysOfCode");
